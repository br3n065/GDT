"Friends/FriendsDialog.res"
{
	...
	styles
	{
      ...
      render_bg
      {
        ...
        2="fill(x0, y0+29, x1-1, y0+30, gdt.darkred)"
      }
		}
    ...
    FriendsTitle:FrameFocus
      ...
      render_bg
      {
        ...
        2="fill(x0, y0+29, x1-1, y0+30, gdt.red)"
      }
		}
      ...
      render_bg
      {
		...
		FriendsSearch
		{
			...
			render_bg
			{
				0="fill(x0+1, y0+1, x1+1, y1, gdt.nav)"
			}
		}
		...
		FriendsSearchIcon
		{
			...
			render_bg
			{
				0="fill(x0+2, y0-1, x1+2, y1+3, gdt.nav)"
			}
		}
		...
		FriendsSearchIcon:disabled
		{
			...
			render_bg
			{
				0="fill(x0+1, y0+1, x1-1, y1-1, gdt.nav)"
			}
		}
	}
